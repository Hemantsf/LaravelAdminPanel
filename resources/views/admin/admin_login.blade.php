    ...
    <body>
        ...
        @endif
            <form id="loginform" class="form-vertical" method="post" action="{{url('admin')}}">{{ csrf_field() }}
				 <div class="control-group normal_text"> <h3><img src="{{ asset('images/backendimages/logo.png')}}" alt="Logo" /></h3></div>
        ...
        <script src="{{ asset('js/backendjs/matrix.login.js')}}"></script>
        <script src="{{ asset('js/backendjs/bootstap.min.js')}}"></script> 
    </body>
